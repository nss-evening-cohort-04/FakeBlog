namespace FakeBlog.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
        ...
        {
            DropForeignKey("dbo.Retweets", "Tweet_TweetId", "dbo.Tweets");
            DropForeignKey("dbo.Tweets", "Owner_Id", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "RoleId", "dbo.AspNetRoles");
            DropIndex("dbo.Retweets", new[] { "Tweet_TweetId" });
            DropIndex("dbo.AspNetUserLogins", new[] { "UserId" });
            DropIndex("dbo.AspNetUserClaims", new[] { "UserId" });
            DropIndex("dbo.AspNetUsers", "UserNameIndex");
            DropIndex("dbo.Tweets", new[] { "Owner_Id" });
